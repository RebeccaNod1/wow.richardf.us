    ...
    button.addEventListener('click', () => {
        ...
        if (tab === 'news') {
            ...
            contentBox.innerHTML = `
                        ...
                        <p><a href="https://github.com/RebeccaNod1/wow.richardf.us/issues" target="_blank" class="intro-button" style="display:inline-block; margin-top:10px;">Go to Bugtracker</a></p>
                    `;
        } else if (tab === 'stream') {
            contentBox.innerHTML = `
                        <h2>Live Stream</h2>
